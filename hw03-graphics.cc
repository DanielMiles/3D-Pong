...
# define BLINK(txt,pad) ( blink_visible ? txt : pad )
  ...
  ogl_helper.fbprintf
    ("Shadows: %s ('d')  Eye location:b [%5.1f, %5.1f, %5.1f]  "
...
World::cb_keyboard()
{
  ...
  case '8': mp.game.paddles[1].move(pVect(0,1,0)); break;
  case '4': mp.game.paddles[1].move(pVect(0,0,1)); break;
  case '2': mp.game.paddles[1].move(pVect(0,-1,0)); break;
  case '6': mp.game.paddles[1].move(pVect(0,0,-1)); break;
